...
private[chisel3] trait BoringUtils$Intf { self: BoringUtils.type =>
  ...
  /** Access a source [[Data]] that may or may not be in the current module.  If
    ...
    * requested source.
    */
  def bore[A <: Data](source: A)(implicit si: SourceInfo): A = _boreImpl(source)
  ...
  /** Access a sink [[Data]] for driving that may or may not be in the current module.
    ...
    */
  def drive[A <: Data](sink: A)(implicit si: SourceInfo): A = _driveImpl(sink)
  ...
  /** Access a source [[Data]] that may or may not be in the current module.  If
    ...
    */
  def tap[A <: Data](source: A)(implicit si: SourceInfo): A = _tapImpl(source)
  ...
  /** Access a source [[Data]] that may or may not be in the current module.  If
    ...
    * Returns a probe Data type.
    */
  def rwTap[A <: Data](source: A)(implicit si: SourceInfo): A = _rwTapImpl(source)
  ...
  /** Access a source [[Data]] that may or may not be in the current module.  If
    ...
    */
  def tapAndRead[A <: Data](source: A)(implicit si: SourceInfo): A = _tapAndReadImpl(source)
}
