...
object MixedVec {
  ...
  /**
    ...
    */
  def apply[T <: Data](val0: T, vals: T*)(implicit compileOptions: CompileOptions): MixedVec[T] = new MixedVec(
    val0 +: vals.toSeq
  )
  ...
  /**
    ...
    */
  def apply[T <: Data](mixedVec: MixedVec[T])(implicit compileOptions: CompileOptions): MixedVec[T] = new MixedVec(
    mixedVec.elts
  )
...
final class MixedVec[T <: Data](
  private val eltsIn:                                    Seq[T]
)(private[chisel3] implicit override val compileOptions: CompileOptions)
    extends Record
