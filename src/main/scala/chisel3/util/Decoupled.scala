...
object Decoupled
{
  ...
  def apply[T <: Data](irr: IrrevocableIO[T]): DecoupledIO[T] = {
    require(DataMirror.directionOf(irr.bits) == Output, "Only safe to cast produced Irrevocable bits to Decoupled.")
...
object Irrevocable
{
  ...
  def apply[T <: Data](dec: DecoupledIO[T]): IrrevocableIO[T] = {
    require(DataMirror.directionOf(dec.bits) == Input, "Only safe to cast consumed Decoupled bits to Irrevocable.")
