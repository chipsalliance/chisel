...
/** Emit a [[chisel3.stage.ChiselCircuitAnnotation ChiselCircuitAnnotation]] to a file if a
  * [[chisel3.stage.ChiselOutputFileAnnotation ChiselOutputFileAnnotation]] is present. A deleted
  ...
  * provide some breadcrumbs such that the emitted CHIRRTL can be provided back to the old Driver. This should be
