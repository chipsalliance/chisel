...
<<<<<<< HEAD:src/test/scala/chiselTests/experimental/hierarchy/Annotations.scala
...
||||||| parent of a95cfe4c (Add safer Chisel annotation API, deprecate old ones (#4643)):src/test/scala-2/chiselTests/experimental/hierarchy/Annotations.scala
  case class MarkChiselHierarchyAnnotation[B <: BaseModule](d: Hierarchy[B], tag: String, isAbsolute: Boolean)
      extends chisel3.experimental.ChiselAnnotation {
    def toFirrtl = MarkAnnotation(d.toTarget, tag)
  }
...
>>>>>>> a95cfe4c (Add safer Chisel annotation API, deprecate old ones (#4643)):src/test/scala-2/chiselTests/experimental/hierarchy/Annotations.scala
}
