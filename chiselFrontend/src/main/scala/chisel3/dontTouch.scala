...
/** Marks that a signal is an optimization barrier to Chisel and the FIRRTL compiler. This has the effect of
  ...
  * dontTouch.
  */
<<<<<<< HEAD:chiselFrontend/src/main/scala/chisel3/dontTouch.scala
...
>>>>>>> f1e37900 (Update docs on dontTouch as optimization barrier (#2015)):core/src/main/scala/chisel3/dontTouch.scala
    *
