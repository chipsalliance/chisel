...
<<<<<<< HEAD:chiselFrontend/src/main/scala/chisel3/internal/Error.scala
  def checkpoint(): Unit = {
    // scalastyle:off line.size.limit regex
=======
  def checkpoint(logger: Logger): Unit = {
>>>>>>> 04caf395 (Change Chisel warnings to use logger instead of println):core/src/main/scala/chisel3/internal/Error.scala
