...
<<<<<<< HEAD:chiselFrontend/src/main/scala/chisel3/internal/firrtl/Converter.scala
...
>>>>>>> c7142802... Add some error context to Converter .getRefs (#1878):core/src/main/scala/chisel3/internal/firrtl/Converter.scala
    case Node(id) =>
