...
/** Defines a black box, which is a module that can be referenced from within
  ...
  */
abstract class ExtModule(val params: Map[String, Param] = Map.empty[String, Param]) extends chisel3.internal.BaseBlackBox {
...
/** Defines a black box, which is a module that can be referenced from within
  ...
  * @note The parameters API is experimental and may change
  */
abstract class BlackBox(val params: Map[String, Param] = Map.empty[String, Param])(implicit compileOptions: CompileOptions) extends chisel3.internal.BaseBlackBox { // scalastyle:ignore line.size.limit
  def io: Record
