...
/** Represents a module viewed from a different instance context.
  ...
  */
private[chisel3] final case class StandInInstance[T <: BaseModule](val proto: T, val instName: () => String, val parent: Option[IsContext]) extends PseudoModule with IsStandIn[T] {
