...
<<<<<<< HEAD:core/src/main/scala/chisel3/Module.scala
...
||||||| parent of a95cfe4c (Add safer Chisel annotation API, deprecate old ones (#4643)):core/src/main/scala/chisel3/ModuleImpl.scala
import chisel3.experimental.{requireIsChiselType, BaseModule, SourceInfo, UnlocatableSourceInfo}
=======
import chisel3.experimental.{requireIsChiselType, BaseModule, SourceInfo, Targetable, UnlocatableSourceInfo}
>>>>>>> a95cfe4c (Add safer Chisel annotation API, deprecate old ones (#4643)):core/src/main/scala/chisel3/ModuleImpl.scala
