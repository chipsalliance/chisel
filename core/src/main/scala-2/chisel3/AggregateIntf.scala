...
private[chisel3] trait VecIntf[T <: Data] extends VecVirtualMethods[T] { self: Vec[T] =>
...
private[chisel3] trait VecInit$Intf extends VecInit$VirtualMethods with SourceInfoDoc { self: VecInit.type =>
...
private[chisel3] trait VecLikeImpl[T <: Data] extends VecLikeVirtualMethods[T] with SourceInfoDoc {
