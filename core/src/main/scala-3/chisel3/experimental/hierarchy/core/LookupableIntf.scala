...
private[chisel3] trait Lookupable$Intf { self: Lookupable.type =>
  ...
  def product1[X, T1: Lookupable](
    in:  X => T1,
    out: T1 => X
  )(using sourceInfo: SourceInfo): Simple[X] = _product1Impl(in, out)
  ...
  def product2[X, T1: Lookupable, T2: Lookupable](
    in:  X => (T1, T2),
    out: (T1, T2) => X
  )(using sourceInfo: SourceInfo): Simple[X] = _product2Impl(in, out)
  ...
  def product3[X, T1: Lookupable, T2: Lookupable, T3: Lookupable](
    in:  X => (T1, T2, T3),
    out: (T1, T2, T3) => X
  )(using sourceInfo: SourceInfo): Simple[X] = _product3Impl(in, out)
  ...
  def product4[X, T1: Lookupable, T2: Lookupable, T3: Lookupable, T4: Lookupable](
    in:  X => (T1, T2, T3, T4),
    out: (T1, T2, T3, T4) => X
  )(using sourceInfo: SourceInfo): Simple[X] = _product4Impl(in, out)
  ...
  )(using sourceInfo: SourceInfo): Simple[X] = _product5Impl(in, out)

  implicit def lookupInstance[B <: BaseModule](using sourceInfo: SourceInfo): Simple[Instance[B]] =
    _lookupInstanceImpl[B]

  @deprecated("Looking up Modules is deprecated, please cast to Instance instead (.toInstance).", "Chisel 7.0.0")
  implicit def lookupModule[B <: BaseModule](using sourceInfo: SourceInfo): Aux[B, Instance[B]] =
    _lookupModuleImpl[B]

  implicit def lookupData[B <: Data](using sourceInfo: SourceInfo): Simple[B] =
    _lookupDataImpl[B]

  implicit def lookupMem[B <: MemBase[_]](using sourceInfo: SourceInfo): Simple[B] =
    _lookupMemImpl[B]

  implicit def lookupHasTarget(using sourceInfo: SourceInfo): Simple[HasTarget] =
  ...
  implicit def lookupIsLookupable[B <: IsLookupable](using sourceInfo: SourceInfo): Simple[B] =
