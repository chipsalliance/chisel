...
sealed abstract class Bits(private[chisel3] val width: Width) extends BitsImpl with ToBoolable {
  ...
  /** Tail operator
    ...
    * @group Bitwise
    */
  def tail(n: Int)(implicit sourceInfo: SourceInfo): UInt = _tailImpl(n)
  ...
  /** Head operator
    ...
    * @group Bitwise
    */
  def head(n: Int)(implicit sourceInfo: SourceInfo): UInt = _headImpl(n)
  ...
  final def extract(x:    BigInt)(implicit sourceInfo: SourceInfo): Bool = _extractImpl(x)
  ...
  /** Returns the specified bit on this $coll as a [[Bool]], statically addressed.
    ...
    * @return the specified bit
    */
  final def apply(x: Int)(implicit sourceInfo: SourceInfo): Bool = _applyImpl(x)

  /** Grab the bottom n bits.  Return 0.U(0.W) if n==0. */
  final def take(n: Int)(implicit sourceInfo: SourceInfo): UInt = _takeImpl(n)
  ...
  /** Returns the specified bit on this wire as a [[Bool]], dynamically addressed.
    ...
    * @return the specified bit
    */
  final def extract(x: UInt)(implicit sourceInfo: SourceInfo): Bool = _extractImpl(x)
  ...
  /** Returns the specified bit on this wire as a [[Bool]], dynamically addressed.
    ...
    * @return the specified bit
    */
  final def apply(x: UInt)(implicit sourceInfo: SourceInfo): Bool = _applyImpl(x)
  ...
  /** Returns a subset of bits on this $coll from `hi` to `lo` (inclusive), statically addressed.
    ...
    */
  final def apply(x: Int, y: Int)(implicit sourceInfo: SourceInfo): UInt = _applyImpl(x, y)
  ...
  /** Returns a subset of bits on this $coll from `hi` to `lo` (inclusive), statically addressed.
    ...
    * @return a hardware component contain the requested bits
    */
  final def apply(x: BigInt, y: BigInt)(implicit sourceInfo: SourceInfo): UInt = _applyImpl(x, y)
  ...
  /** Pad operator
    ...
    * @group Bitwise
    */
  def pad(that: Int)(implicit sourceInfo: SourceInfo): Bits = _padImpl(that)
  ...
  /** Bitwise inversion operator
    ...
    * @group Bitwise
    */
  def unary_~(implicit sourceInfo: SourceInfo): Bits = _impl_unary_~
  ...
  /** Static left shift operator
    ...
    * @group Bitwise
    */
  def <<(that: BigInt)(implicit sourceInfo: SourceInfo): Bits = _impl_<<(that)
  ...
  /** Static left shift operator
    ...
    * @group Bitwise
    */
  def <<(that: Int)(implicit sourceInfo: SourceInfo): Bits = _impl_<<(that)
  ...
  /** Dynamic left shift operator
    ...
    * @group Bitwise
    */
  def <<(that: UInt)(implicit sourceInfo: SourceInfo): Bits = _impl_<<(that)
  ...
  def asBools(implicit sourceInfo: SourceInfo): Seq[Bool] = _asBoolsImpl
  ...
  /** Reinterpret this $coll as an [[SInt]]
    ...
    */
  def asSInt(implicit sourceInfo: SourceInfo): SInt = _asSIntImpl
  ...
  /** Concatenation operator
    ...
    * @group Bitwise
    */
  def ##(that: Bits)(implicit sourceInfo: SourceInfo): UInt = _impl_##(that)
}
...
sealed class UInt private[chisel3] (width: Width) extends Bits(width) with UIntImpl {
  ...
  /** Unary negation (expanding width)
    ...
    * @group Arithmetic
    */
  def unary_-(implicit sourceInfo: SourceInfo): UInt = _impl_unary_-
  ...
  /** Exclusive or (xor) reduction operator
    ...
    * @group Bitwise
    */
  final def xorR(implicit sourceInfo: SourceInfo): Bool = _xorRImpl
  ...
  /** Unary not
    ...
    * @group Bitwise
    */
  def unary_!(implicit sourceInfo: SourceInfo): Bool = _impl_unary_!

  override def <<(that: Int)(implicit sourceInfo:    SourceInfo): UInt = _impl_<<(that)
  override def <<(that: BigInt)(implicit sourceInfo: SourceInfo): UInt = _impl_<<(that)
  override def <<(that: UInt)(implicit sourceInfo:   SourceInfo): UInt = _impl_<<(that)
  ...
  /**
    ...
    */
  def rotateLeft(n: Int)(implicit sourceInfo: SourceInfo): UInt = _rotateLeftImpl(n)

  def rotateLeft(n: UInt)(implicit sourceInfo: SourceInfo): UInt = _rotateLeftImpl(n)
  ...
  /**
    ...
    */
  def rotateRight(n: Int)(implicit sourceInfo: SourceInfo): UInt = _rotateRightImpl(n)

  def rotateRight(n: UInt)(implicit sourceInfo: SourceInfo): UInt = _rotateRightImpl(n)
  ...
  /** Conditionally set or clear a bit
    ...
    * $unchangedWidth
    */
  def bitSet(off: UInt, dat: Bool)(implicit sourceInfo: SourceInfo): UInt = _bitSetImpl(off, dat)
  ...
  /** Zero extend as [[SInt]]
    ...
    */
  def zext(implicit sourceInfo: SourceInfo): SInt = _zextImpl

  override def asSInt(implicit sourceInfo: SourceInfo): SInt = _asSIntImpl
}
...
sealed class SInt private[chisel3] (width: Width) extends Bits(width) with SIntImpl {
  ...
  /** Unary negation (constant width)
    ...
    * @group Arithmetic
    */
  final def unary_-(implicit sourceInfo: SourceInfo): SInt = _impl_unary_-
  ...
  /** Unary negation (constant width)
    ...
    * @group Arithmetic
    */
  def unary_-%(implicit sourceInfo: SourceInfo): SInt = _impl_unary_-%
  ...
  /** Multiplication operator
    ...
    * @group Arithmetic
    */
  def *(that: UInt)(implicit sourceInfo: SourceInfo): SInt = _impl_*(that)
  ...
  /** Addition operator (expanding width)
    ...
    * @group Arithmetic
    */
  def +&(that: SInt)(implicit sourceInfo: SourceInfo): SInt = _impl_+&(that)
  ...
  override def unary_~(implicit sourceInfo: SourceInfo): SInt = _impl_unary_~
  ...
  override def <<(that: Int)(implicit sourceInfo:    SourceInfo): SInt = _impl_<<(that)
  override def <<(that: BigInt)(implicit sourceInfo: SourceInfo): SInt = _impl_<<(that)
  override def <<(that: UInt)(implicit sourceInfo:   SourceInfo): SInt = _impl_<<(that)
...
sealed trait Reset extends ResetImpl with ToBoolable {
  def asAsyncReset(implicit sourceInfo: SourceInfo): AsyncReset
  def asDisable(implicit sourceInfo:    SourceInfo): Disable = _asDisableImpl
}
...
final class ResetType(private[chisel3] val width: Width = Width(1)) extends Reset with ResetTypeImpl with ToBoolable {
  def asAsyncReset(implicit sourceInfo: SourceInfo): AsyncReset = _asAsyncResetImpl
  def asBool: Bool = _asBoolImpl
...
sealed class Bool() extends UInt(1.W) with BoolImpl with Reset {
  ...
  /** Bitwise and operator
    ...
    * @group Bitwise
    */
  def &(that: Bool)(implicit sourceInfo: SourceInfo): Bool = _impl_&(that)
  ...
  override def unary_~(implicit sourceInfo: SourceInfo): Bool = _impl_unary_~
  ...
  def asClock(implicit sourceInfo: SourceInfo): Clock = _asClockImpl
